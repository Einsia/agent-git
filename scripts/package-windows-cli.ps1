...
& cargo test --locked --release --target $target --test status_branch_sync -- --nocapture --test-threads=1
if ($LASTEXITCODE -ne 0) { throw 'Windows branch, shared-file, and merge status tests failed' }
